  ...
  Widget _buildProjectCard(Project project) {
    return ListTile(
      ...
      subtitle: Column(
        ...
        children: [
          Text(
            'Du ${DateFormat('dd/MM/yyyy HH:mm').format(project.startDate)} ',
          ),
          Text(
            'au ${DateFormat('dd/MM/yyyy HH:mm').format(project.endDate)}',
          ),
          Text(
            'Budget: ${project.budget}', // Add this line to display the budget
